    ...
    wx.showModal({
      ...
      success: function(res) {
        res.confirm && wx.request({
          url: app.d.myUrl + '/Api/Order/orders_edit',
          method:'post',
          data: {
            id: orderId,
            type:'cancel',
...
recOrder:function(e){
  ...
  loadOrderList: function(){
    var that = this;
    wx.request({
      url: app.d.myUrl + '/Api/Order/index',
      method:'post',
      data: {
        uid:app.d.userId,
...
loadReturnOrderList:function(){
    var that = this;
    wx.request({
      url: app.d.myUrl + '/Api/Order/order_refund',
      method:'post',
      data: {
        uid:app.d.userId,
      },
...
getMore: function (e) {
  ...
  wx.request({
    url: app.d.myUrl + '/Api/Order/get_more',
    method: 'post',
    data: {
      uid: app.d.userId,
      order_type: that.data.isStatus,
...
getMore2: function (e) {
  ...
  wx.request({
    url: app.d.myUrl + '/Api/Order/get_refund_more',
    method: 'post',
    data: {
      uid: app.d.userId,
  ...
  payOrderByWechat: function (e) {
    ...
    wx.request({
      url: app.d.myUrl + '/Api/Pay/dowxpay',
      data: {
        order_id: order_id,
        order_sn: order_sn,
        uid: app.d.userId,
